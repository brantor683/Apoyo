...
public class SolicitudDAO {
        ...
        try {
            String strSQL = "INSERT INTO SOLICITUD (k_idSolicitud, e_estSolicitud, k_est_codEstudiante,"
                    + " k_conv_convocatoria, d_diasbeneficio, F_solicitud) VALUES(?,?,?,?,?,?)";
            ...
            prepStmt.setInt(4, s.getK_conv_convocatoria());
            prepStmt.setInt(5, s.getD_diasbeneficio());
            prepStmt.setString(6, s.getF_solicitud());
