...
public class UsuarioDAO {
    ...
    public String ingresar(Usuario user) throws RHException {
       ...
       public String crearUsuarioEstudiante(Usuario userInicial, Usuario nuevoUsuario) {
        ...
        try {
            String strSQL = "CREATE USER " + nuevoUsuario.getUser()+ " IDENTIFIED BY " + nuevoUsuario.getPasswd() + " DEFAULT TABLESPACE APOYOALIMENTARIODEF TEMPORARY TABLESPACE APOYOALIMENTARIOTEMP";
