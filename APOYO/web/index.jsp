							...
							<div class="navArea">
								<div class="navbar-collapse collapse">
									<ul class="nav navbar-nav">
                                        ...
                                        <li class="menuItem"><a href="#funcionarios">Portal Funcionarios</a></li>
									</ul>
								</div>
							</div>
						</div>
...
Actualmente la Universidad Distrital se encuentra realizando una nueva convocatoria para acceder a este programa, para el cual si usted es estudiante debe cumplir con algunos requisitos</h3>
	...
	<div class="container w960">
		...
		<form class="form-login" action="login/registrarUsuario.jsp" method="post" >
		            ...
		            <input type="number" name='user' class="form-control" placeholder="CÛdigo Estudiante"  required>
		            <br>
		             <input type="password" name='passwd' class="form-control" placeholder="ContraseÒa"  required>
	 ...
	 <div class="container w960">
      <div class="row">
        ...
        <form class="form-login" action="login/Ubottons/MenuInicial.jsp" method="post">
		            ...
		            <input type="text" class="form-control" name="user" placeholder="CÛdigo Estudiante" required>
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.html#myModal"> Olvido su contraseÒa?</a>
		
		                </span>
		            </label>
		            <button class="btn btn-theme btn-block"  type="submit" name="submit"><i class="fa fa-lock"></i>Iniciar SesiÛn</button>
		            <hr>
